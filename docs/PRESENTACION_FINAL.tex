...
\begin{itemize}
    ...
    (la \emph{fiel al paper}): AUC $= \mathbf{0.856 \pm 0.022}$,
...
\end{table}
\vspace{2pt}
{\scriptsize Vainilla: brecha $-0.078 \to -0.028$. \quad
Grad-CAM: $+0.087 \to +0.056$.}
\end{column}
...
\end{itemize}
\centering\footnotesize Ninguna sobrevive BH-FDR ($q \geq 0.58$).
\end{block}
\end{column}
\end{columns}
...
indistinguibles.} \\
\small La diferencia aparente (en ambos sentidos) era el \textbf{artefacto
de DSP}, no la transformada.
