...
\begin{enumerate}[leftmargin=*]
    ...
    significativa. \textbf{No encontramos evidencia de que la elección
    STFT vs CWT-Morlet cambie el desempeño una vez controlado el eje}
    (potencia limitada, 3~seeds); ni la hipótesis original (CWT > STFT)
    ni la inversa obtienen evidencia.
